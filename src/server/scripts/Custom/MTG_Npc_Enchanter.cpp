...
public:
	...
	{
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateHelm:35:35:-14|t Head",							GOSSIP_SENDER_MAIN, 1);		// Head
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateShoulder:35:35:-14|t Shoulders",					GOSSIP_SENDER_MAIN, 2);		// Shoulders
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateChest:35:35:-14|t Chest",							GOSSIP_SENDER_MAIN, 3);		// Chest
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateGloves:35:35:-14|t Gloves",						GOSSIP_SENDER_MAIN, 4);		// Gloves
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlatePants:35:35:-14|t Legs",							GOSSIP_SENDER_MAIN, 5);		// Legs
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateBracer:35:35:-14|t Bracers",						GOSSIP_SENDER_MAIN, 6);		// Bracers
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateBelt:35:35:-14|t Belt ",							GOSSIP_SENDER_MAIN, 7);		// Belt
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Desecrated_PlateBoots:35:35:-14|t Feet",							GOSSIP_SENDER_MAIN, 8);		// Feet
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Misc_Cape_11:35:35:-14|t Cloak",										GOSSIP_SENDER_MAIN, 9);		// Cloak
	if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) == 450) // Requer Enchanting 450
	 {
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Jewelry_Ring_01:35:35:-14|t Ring 1",									GOSSIP_SENDER_MAIN, 10);	// Ring 1
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Jewelry_Ring_01:35:35:-14|t Ring 2",									GOSSIP_SENDER_MAIN, 11);	// Ring 2
	 }
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Sword_04:35:35:-14|t Main Hand",										GOSSIP_SENDER_MAIN, 12);	// Main Hand
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Shield_04:35:35:-14|t Off Hand",										GOSSIP_SENDER_MAIN, 13);	// Off Hand
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Weapon_Crossbow_04:35:35:-14|t Ranged",								GOSSIP_SENDER_MAIN, 14);	// Ranged
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
	{
		...
		case 1:	// HEAD
		{
			...
			{
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Attack Power +20 Critical",				GOSSIP_SENDER_MAIN, 1000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Attack Power +20 Resilience",			GOSSIP_SENDER_MAIN, 1001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Spell Power +20 Critical",				GOSSIP_SENDER_MAIN, 1002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +29 Spell Power +20 Resilience",				GOSSIP_SENDER_MAIN, 1003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Spell Power +10 Mp5",					GOSSIP_SENDER_MAIN, 1004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Stamina +25 Resilience",					GOSSIP_SENDER_MAIN, 1005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +37 Stamina +20 Defense",					GOSSIP_SENDER_MAIN, 1006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Arcane Resist +30 Stamina",				GOSSIP_SENDER_MAIN, 1007);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Fire Resist +30 Stamina",				GOSSIP_SENDER_MAIN, 1008);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Shadow Resist +30 Stamina",				GOSSIP_SENDER_MAIN, 1009);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Frost Resist +30 Stamina",				GOSSIP_SENDER_MAIN, 1010);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Nature Resist +30 Stamina",				GOSSIP_SENDER_MAIN, 1011);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",					GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		if (player->HasSkill(SKILL_INSCRIPTION) && player->GetSkillValue(SKILL_INSCRIPTION) == 450)
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +120 Attack Power +15 Critical",						GOSSIP_SENDER_MAIN, 2000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Spell Power +15 Critical",						GOSSIP_SENDER_MAIN, 2001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Spell Power +8 Mp5",								GOSSIP_SENDER_MAIN, 2002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +60 Dodge +15 Defense",								GOSSIP_SENDER_MAIN, 2003);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Attack Power +15 Critical",						GOSSIP_SENDER_MAIN, 2004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Attack Power +15 Resilience",					GOSSIP_SENDER_MAIN, 2005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +24 Spell Power +15 Critical",						GOSSIP_SENDER_MAIN, 2006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +23 Spell Power +15 Resilience",						GOSSIP_SENDER_MAIN, 2007);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +24 Spell Power +8 Mp5",								GOSSIP_SENDER_MAIN, 2008);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Stamina +15 Resilience",							GOSSIP_SENDER_MAIN, 2009);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +20 Dodge +15 Defense",								GOSSIP_SENDER_MAIN, 2010);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",							GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		case 3: // CHEST
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +10 All Stats",							GOSSIP_SENDER_MAIN, 3000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +275 Health",							GOSSIP_SENDER_MAIN, 3001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +10 Mp5",								GOSSIP_SENDER_MAIN, 3002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +20 Resilience",							GOSSIP_SENDER_MAIN, 3003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +22 Defense",							GOSSIP_SENDER_MAIN, 3004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",				GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
		return true;
		...
		if (player->HasSkill(SKILL_BLACKSMITHING) && player->GetSkillValue(SKILL_BLACKSMITHING) == 450)	// BLACKSMITHING
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Socket Gloves",								GOSSIP_SENDER_MAIN, 4000);
		 }
		if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450) // ENGINE
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Hand-Mounted Pyro Rocket",					GOSSIP_SENDER_MAIN, 4001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Hyperspeed +340 Haste Rating",				GOSSIP_SENDER_MAIN, 4002);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +44 Attack Power",							GOSSIP_SENDER_MAIN, 4003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +28 Spell Power",							GOSSIP_SENDER_MAIN, 4004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +20 Agility",								GOSSIP_SENDER_MAIN, 4005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +20 Hit Rating",								GOSSIP_SENDER_MAIN, 4006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +16 Critical Rating",						GOSSIP_SENDER_MAIN, 4007);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +15 Expertise Rating",						GOSSIP_SENDER_MAIN, 4008);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +10 Parry Rating + 2% Threat",				GOSSIP_SENDER_MAIN, 4009);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",					GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		case 5: // LEGS
		{
			...
			{
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +75 Attack Power +22 Critical",				GOSSIP_SENDER_MAIN, 5000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Spell Power +20 Spirit",					GOSSIP_SENDER_MAIN, 5001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Spell Power +30 Stamina",				GOSSIP_SENDER_MAIN, 5002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Reslience +28 Stamina",					GOSSIP_SENDER_MAIN, 5003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +55 Stamina +22 Agility",					GOSSIP_SENDER_MAIN, 5004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",					GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		if (player->HasSkill(SKILL_LEATHERWORKING) && player->GetSkillValue(SKILL_LEATHERWORKING) == 450)
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +130 Attack Power",							GOSSIP_SENDER_MAIN, 6000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +102 Stamina",								GOSSIP_SENDER_MAIN, 6001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +76 Spell Power",							GOSSIP_SENDER_MAIN, 6002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Arcane Resistance",						GOSSIP_SENDER_MAIN, 6003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Fire Resistance",						GOSSIP_SENDER_MAIN, 6004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Frost Resistance",						GOSSIP_SENDER_MAIN, 6005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Nature Resistance",						GOSSIP_SENDER_MAIN, 6006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +70 Shadow Resistance",						GOSSIP_SENDER_MAIN, 6007);
		 }
		if (player->HasSkill(SKILL_BLACKSMITHING) && player->GetSkillValue(SKILL_BLACKSMITHING) == 450)
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Socket Bracer",								GOSSIP_SENDER_MAIN, 6008);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Attack Power",							GOSSIP_SENDER_MAIN, 6009);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Stamina",								GOSSIP_SENDER_MAIN, 6010);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Spell Power",							GOSSIP_SENDER_MAIN, 6011);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +18 Spirit",									GOSSIP_SENDER_MAIN, 6012);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +15 Expertise",								GOSSIP_SENDER_MAIN, 6013);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +6 All Stats",								GOSSIP_SENDER_MAIN, 6014);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",					GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450) // ENGINE
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Frag Belt",								GOSSIP_SENDER_MAIN, 7000);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Eternal Belt Buckle",					GOSSIP_SENDER_MAIN, 7001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",				GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450) // ENGINE
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Nitro Boots",							GOSSIP_SENDER_MAIN, 8000);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +32 Attack Power",						GOSSIP_SENDER_MAIN, 8001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +22 Stamina",							GOSSIP_SENDER_MAIN, 8002);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +15 Stamina +Movement Speed",			GOSSIP_SENDER_MAIN, 8003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +16 Agility",							GOSSIP_SENDER_MAIN, 8004);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +18 Spirit",								GOSSIP_SENDER_MAIN, 8005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +12 Hit Rating +Crit Rating",			GOSSIP_SENDER_MAIN, 8006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +7 Mp5 +Health every 5 Seconds",			GOSSIP_SENDER_MAIN, 8007);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",				GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		if (player->HasSkill(SKILL_TAILORING) && player->GetSkillValue(SKILL_TAILORING) == 450)
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Swordguard +400 Attack Power",				GOSSIP_SENDER_MAIN, 9000);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Darkglow +400 Mana",							GOSSIP_SENDER_MAIN, 9001);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Lightweave +295 Spell Power",				GOSSIP_SENDER_MAIN, 9002);
		 }
		if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450) // ENGINE
		 {
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Flexweave Underlay",							GOSSIP_SENDER_MAIN, 9003);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Springy Arachnoweave",						GOSSIP_SENDER_MAIN, 9004);
		 }
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +225 Armor",									GOSSIP_SENDER_MAIN, 9005);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +23 Haste",									GOSSIP_SENDER_MAIN, 9006);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +22 Agility",								GOSSIP_SENDER_MAIN, 9007);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +16 Defense",								GOSSIP_SENDER_MAIN, 9008);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +10 Agility +Stealth Increase",				GOSSIP_SENDER_MAIN, 9009);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +10 Spirit +Reduce threat",					GOSSIP_SENDER_MAIN, 9010);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-14|tVoltar",						GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		case 10: // RING 1
		{
			...
			{
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Attack Power",				GOSSIP_SENDER_MAIN, 1100);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Stamina",					GOSSIP_SENDER_MAIN, 1101);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +23 Spell Power",				GOSSIP_SENDER_MAIN, 1102);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",		GOSSIP_SENDER_MAIN, 300);
			player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
		...
		case 11: // RING 2
		{
			...
			if (item->GetTemplate()->InventoryType == INVTYPE_FINGER)
			{
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Attack Power", GOSSIP_SENDER_MAIN, 1110);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +30 Stamina", GOSSIP_SENDER_MAIN, 1111);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +23 Spell Power", GOSSIP_SENDER_MAIN, 1112);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar", GOSSIP_SENDER_MAIN, 300);
				player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
...

		{
			...
			{
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Battlemaster",				GOSSIP_SENDER_MAIN, 1200);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Berserking",					GOSSIP_SENDER_MAIN, 1201);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Black Magic",				GOSSIP_SENDER_MAIN, 1202);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Blood Draining",				GOSSIP_SENDER_MAIN, 1203);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Blade Warding",				GOSSIP_SENDER_MAIN, 1204);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Executioner",				GOSSIP_SENDER_MAIN, 1205);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Icebreaker",					GOSSIP_SENDER_MAIN, 1206);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Lifeward",					GOSSIP_SENDER_MAIN, 1207);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Mongoose",					GOSSIP_SENDER_MAIN, 1208);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Titanium Weapon Chain",		GOSSIP_SENDER_MAIN, 1209);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +65 Attack Power",			GOSSIP_SENDER_MAIN, 1212);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +63 Spell Power",			GOSSIP_SENDER_MAIN, 1213);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Stamina",				GOSSIP_SENDER_MAIN, 1214);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +45 Spirit",					GOSSIP_SENDER_MAIN, 1215);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +26 Agility",				GOSSIP_SENDER_MAIN, 1216);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Hit Rating +25 Crit",	GOSSIP_SENDER_MAIN, 1217);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",	GOSSIP_SENDER_MAIN, 300);
				player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
				return true;
			}
		...
		
		{
			...
			if (item->GetTemplate()->InventoryType == INVTYPE_2HWEAPON)
			{
				...
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Mongoose",					GOSSIP_SENDER_MAIN, 1208);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Titanium Weapon Chain",		GOSSIP_SENDER_MAIN, 1209);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +110 Attack Power",			GOSSIP_SENDER_MAIN, 1210);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +81 Spellpower",				GOSSIP_SENDER_MAIN, 1211);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +65 Attack Power",			GOSSIP_SENDER_MAIN, 1212);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +63 Spell Power",			GOSSIP_SENDER_MAIN, 1213);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Stamina",				GOSSIP_SENDER_MAIN, 1214);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +45 Spirit",					GOSSIP_SENDER_MAIN, 1215);
			...
			// OFF HAND
		{
			...
			{
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Battlemaster",				GOSSIP_SENDER_MAIN, 1300);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Berserking",					GOSSIP_SENDER_MAIN, 1301);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Blood Draining",				GOSSIP_SENDER_MAIN, 1303);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Blade Warding",				GOSSIP_SENDER_MAIN, 1304);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Executioner",				GOSSIP_SENDER_MAIN, 1305);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Icebreaker",					GOSSIP_SENDER_MAIN, 1306);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Lifeward",					GOSSIP_SENDER_MAIN, 1307);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Mongoose",					GOSSIP_SENDER_MAIN, 1308);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t Titanium Weapon Chain",		GOSSIP_SENDER_MAIN, 1309);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +65 Attack Power",			GOSSIP_SENDER_MAIN, 1312);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +63 Spell Power",			GOSSIP_SENDER_MAIN, 1313);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +50 Stamina",				GOSSIP_SENDER_MAIN, 1314);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +45 Spirit",					GOSSIP_SENDER_MAIN, 1315);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +26 Agility",				GOSSIP_SENDER_MAIN, 1316);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Hit Rating +25 Crit",	GOSSIP_SENDER_MAIN, 1317);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",	GOSSIP_SENDER_MAIN, 300);
				player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
				return true;
			}
...

		{
			...
			{
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +81 Block & -50% Disarm",			GOSSIP_SENDER_MAIN, 1320);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +36 Block Value",					GOSSIP_SENDER_MAIN, 1321);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +25 Intellect",					GOSSIP_SENDER_MAIN, 1322);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +20 Defense Rating",				GOSSIP_SENDER_MAIN, 1323);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +18 Stamina",						GOSSIP_SENDER_MAIN, 1324);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +15 Shield Block Rating",			GOSSIP_SENDER_MAIN, 1325);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +12 Resilience",					GOSSIP_SENDER_MAIN, 1326);		
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar", GOSSIP_SENDER_MAIN, 300);
				player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
				return true;
			}
		...
		case 14: // RANGED
		{
			...
			{
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Ranged Critical Strike",						GOSSIP_SENDER_MAIN, 1400);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\INV_Scroll_03:30:30:-14|t +40 Ranged Haste Rating",						GOSSIP_SENDER_MAIN, 1401);
				AddGossipItemFor(player, GOSSIP_ICON_INTERACT_2, "|TInterface\\PaperDollInfoFrame\\UI-GearManager-Undo:30:30:-14|tVoltar",						GOSSIP_SENDER_MAIN, 300);
				player->PlayerTalkClass->SendGossipMenu(1, creature->GetGUID());
			}
